...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double salarioLiquido = Calculos.calculaSalarioLiquido(salarioBruto, descontoINSS, descontosIRRF,
                numeroDependentes);
        double irrf = Calculos.calculaIRRF(salarioBruto, descontoINSS, descontosIRRF, numeroDependentes);

        Trabalhador trabalhador = new Trabalhador(nome, salarioBruto, descontoINSS, numeroDependentes, descontosIRRF,
                cpf, cep, endereco, salarioLiquido, irrf);
