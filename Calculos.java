...
public class Calculos {
    ...
    public static double calculaIRRF(double salarioBruto, double descontoINSS, double descontosIRRF,
    ...
    public static double calculaSalarioLiquido(double salarioBruto, double descontoINSS, double descontosIRRF,
            int numeroDependentes) {
